...
class Ban(object):
	def __init__(self,x,y):
		self.image = pygame.image.load("./img/mini_board.jpg")
		...
		img1 = pygame.image.load("./img/blue.png")
		self.blue_image = pygame.transform.scale(img1,(79,98)) 

		img2 = pygame.image.load("./img/red.png")
		self.red_image = pygame.transform.scale(img2,(79,98))

		#moti_kaku = Koma("./img/koma/kakuA.png",False,530,320)

		fu_front_img_lst = {"player":"./img/koma/chick_up.png","cpu":"./img/koma/chick_down.png"}
		fu_nari_img_lst = {"player":"./img/koma/chicken_up.png","cpu":"./img/koma/chicken_down.png"}
		...
		kaku_img_lst ={"player":"./img/koma/elephant_up.png","cpu":"./img/koma/elephant_down.png"}
		...
		hi_img_lst ={"player":"./img/koma/giraffe_up.png","cpu":"./img/koma/giraffe_down.png"}
		...
		ou_img_lst ={"player":"./img/koma/lion_up.png","cpu":"./img/koma/lion_down.png"}
	...
	def blue_draw(self,screen,pos):
		rectX = 280+(pos[0] - 1) * 80
		rectY = (pos[1] - 1) * 100

		screen.blit(self.blue_image, (rectX,rectY))

	def blueFiled(self,screen,pos_lst):
		for pos in pos_lst:
			self.blue_draw(screen,pos)
		pygame.display.update()
